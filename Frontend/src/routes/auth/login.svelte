...
<section class="py-12"><div class="container px-4 mx-auto">
	<form on:submit|preventDefault={handleLogin}>
		...
		<div class="my-12">
			...
			<input class="w-full py-4 text-xs placeholder-blueGray-400 font-semibold leading-none bg-blueGray-50 outline-none" type="email" placeholder="email@bc.edu" bind:value={email}><svg class="h-6 w-6 ml-4 my-auto text-blueGray-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 12a4 4 0 10-8 0 4 4 0 008 0zm0 0v1.5a2.5 2.5 0 005 0V12a9 9 0 10-9 9m4.5-1.206a8.959 8.959 0 01-4.5 1.207"></path></svg></div>
			<button class="block w-full p-4 text-center text-xs text-white font-semibold leading-none bg-blue-600 hover:bg-blue-700 rounded" type="submit" disabled={loading}>{loading ? "Loading" : "Log In / Sign Up"}</button>
		</div>
		</div>
	</form>
  </section>